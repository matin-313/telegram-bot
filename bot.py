...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """دستور راهنمای سریع برای کاربران"""
    
    help_text = (
        "📚 **راهنمای سریع ربات**\n\n"
        "🔹 **ثبت‌نام:**\n"
        "از منوی اصلی رشته مورد نظر را انتخاب کنید\n"
        "👉 ⚽ فوتسال | 🏀 بسکتبال | 🏐 والیبال | 🤝 اشتراکی\n\n"
        
        "🔹 **مشاهده تایم‌ها:**\n"
        "بعد از انتخاب رشته، تایم‌های موجود نمایش داده می‌شود\n\n"
        
        "🔹 **ورود شماره:**\n"
        "شماره موبایل را با فرمت 09123456789 وارد کنید\n\n"
        
        "🔹 **لیست ثبت‌نام‌ها:**\n"
        "از دکمه 📋 لیست ثبت‌نام‌ها استفاده کنید\n\n"
        
        "🔹 **تماس با ادمین:**\n"
        "از دکمه 📨 تماس با ادمین استفاده کنید\n\n"
        
        "🔹 **لغو عملیات:**\n"
        "دستور /cancel را بزنید\n\n"
        
        "⚠️ **نکات مهم:**\n"
        "• فقط در روز مسابقه می‌توانید ثبت‌نام کنید\n"
        "• ۳۰ دقیقه قبل از شروع، ثبت‌نام بسته می‌شود\n"
        "• ظرفیت هر تایم محدود است\n\n"
...
def main():
    ...
    # ✅ هندلر راهنما (قبل از handle_user_message)
    app.add_handler(MessageHandler(
